...
Analyse de trois datasets réels (Kaggle) avec **NumPy** et **Pandas** uniquement — aucun Machine Learning.
...
|------|--------------------|
| Jour 1 | Téléchargement des 3 datasets, compréhension, exploration (Partie 1) et nettoyage (Partie 2). |
| Jour 2 | Sujet 1 Titanic complet + début Sujet 2 (tout le groupe). |
| Jour 3 | Fin Sujet 2 + Sujet 3 (tout le groupe). |
| Jour 4 | Finalisation des analyses avancées et conclusions (`conclusions.pdf`), relecture croisée et vérification du code avant remise. |
